  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        "outline-success":
          "border border-success text-success bg-background shadow-sm hover:bg-success hover:text-success-foreground",
        "outline-warning":
          "border border-warning text-warning bg-background shadow-sm hover:bg-warning hover:text-warning-foreground",
        "outline-info":
          "border border-info text-info bg-background shadow-sm hover:bg-info hover:text-info-foreground",
        "outline-secondary":
